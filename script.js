...
//API Setup
const API_KEY = "AIzaSyCVKAmZlEGrkbUMHpMFpI2aIi6MVZn3CAM";
...
const generateBotResponse = async (incomingMessageDiv) => {
    ...
    try {
        ...
        //Reset users file data, removing thinking indicator and scrall chat to bottom
        userData.file = {};
